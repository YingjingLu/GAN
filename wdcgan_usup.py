# Code partially adopt from Bayesian GAN
# generator framework partially aopted from DCGAN
    ...
    def build_bgan_graph(self):
        ...
        for gi, gen_params in enumerate(self.gen_param_list):
            ...
            for disc_params in self.disc_param_list:
                ...
                g_loss_ = -tf.reduce_mean(d_logits_) 
            ...
            g_loss = tf.reduce_mean(tf.concat(gi_losses, 0))
